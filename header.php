...
//$keyword = $_GET['keyword'];//|| $_SESSION['keyword'] || 'Car Accident';
$keyword = str_replace('-',' ',$_GET['keyword']);
#$city = $_REQUEST['city'] || 'Knoxville';
#$state = $_REQUEST['state'] || 'Tennessee';
#$keyword = $_REQUEST['keyword'] || 'Car Accident';
//$_SESSION['city']=$city;
...
<head>
  <!-- Metadata -->
  <meta charset="UTF-8">
  <title>Crash Legal | <?php echo $keyword ?> Attorneys in <?php echo $city . ", " . $state; ?></title>
    <title>The time you have to pursue a claim is limited</title>
  ...
  <!--[if lt IE 9]>
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-TZMZ937');</script>
    ...
    <header id="header">
      ...
      <nav id="nav">
        <ul>
          ...
          <li class="opener"><a href="tel:+18886610539" class="button">CALL NOW: (888) 661-0539</a>
          </li>
        </ul>
      </nav>
    </header>
